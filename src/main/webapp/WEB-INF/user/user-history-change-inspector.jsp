                ...
                <nav class="navbar navbar-expand-lg navbar-light navigation">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-auto main-nav ">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link"
                                   href="${pageContext.request.contextPath}/taxreturn/history?page=1"><fmt:message
...
<c:if test="${not empty reportList}">
    <section class="dashboard" style=" padding: 2% 15% 2% 15%;">
                ...
                <table class="table">
                    ...
                    <c:forEach items="${reportList}" var="report">
                        <form id="change-inspector-form" name="change-inspector" method="post"
                              action="${pageContext.request.contextPath}/taxreturn/change-user-inspector?id=${report.getId()}">
                            <tr>

                                <td class="w-25"><span class="categories col1"><c:out
                                        value="${report.getPreviousInspectorId()}"/></span>
                                </td>
                                ...
                                <c:set value="${report.getUserId()}" var="userId" scope="request"/>
                        ...
                        <c:if test="${currentPage != 1}">
                            <li class="page-item">
                                <a class="page-link" style="width: 120px;"
                                   href="${pageContext.request.contextPath}/taxreturn/history/change?page=${currentPage-1}">
                            ...
                            <c:choose>
                                <c:when test="${currentPage eq i}">
                                    <li class="page-item active">
                                        <a class="page-link"
                                           href="${pageContext.request.contextPath}/taxreturn/history/change?page=${i}">
